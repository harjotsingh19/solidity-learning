...
contract STRUCT {
        ...
        // pass by value
        function passByValue() public returns(Emp[] memory){
            ...
            emp_temp.name ="uset_test";  //pass by value emp.name will remain same 
        ...
        function passByRefernce() public returns(Emp memory){
            Emp storage emp_temp = emp;
            emp_temp.name ="user_test";  //pass by address emp.name will change 
            return emp;
